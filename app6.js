...
const map = new mapboxgl.Map({
  container: 'map',
  style: 'mapbox://styles/lucasebm/cm9lv3idd00ct01rwg83m21mw',
  center: [-96, 37],
  zoom: 3
});
...
function buildSidebar(geojson) {
  ...
  clearBtn.onclick = () => {
    map.setFilter('usa-zip-codes-geo-100m-1-03rr87', ['==', ['get', 'providers'], '___none___']);
  ...
  [...providers].sort().forEach(name => {
    ...
    li.onclick = () => {
      ...
      map.setFilter('usa-zip-codes-geo-100m-1-03rr87', ['in', name, ['get', 'providers']]);
